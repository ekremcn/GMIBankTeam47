...
//                customer.setSsn(line);
    ...
    public static List<String> returnCustomerSSNList(String filePath) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(filePath))) {
            ...
            while (line != null) {
                Customer customer = new Customer();
                customer.setSsn(line.split(", ")[2]); //olusturulan clasdan hangi bilgiyi alacaksak onun index nosu
                sb.append(System.lineSeparator());
                line = br.readLine();
    ...
    public static List<String> returnApplicantsSSN(String filePath) {
        List<String> all = new ArrayList<>();
        try (BufferedReader br = new BufferedReader(new FileReader(filePath))) {
            StringBuilder sb = new StringBuilder();
            String line = br.readLine();
