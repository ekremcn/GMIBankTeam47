...
public class CreateOrEditACustomerPage {
    ...
    public WebElement countryDDTextBox;

    @FindBy(id = "tp-customer-state")
    public WebElement stateTextBox;

    @FindBy(id = "tp-customer-user")
    public WebElement userDdMenu;

    @FindBy(id = "tp-customer-account")
    public WebElement accountDDMenu;

    @FindBy(xpath = "//*[text()='Checking4711']")
    public WebElement checking476;

    @FindBy(xpath = "//*[text()='Saving4711']")
    public WebElement saving476;
